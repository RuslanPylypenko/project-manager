 ...
 */
final class Version20200510101228 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE work_projects_project_departments (work_projects_project_department_id VARCHAR(255) NOT NULL, project_id UUID NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(work_projects_project_department_id))');
